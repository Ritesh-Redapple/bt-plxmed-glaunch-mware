...
class Home extends MY_Controller
{
	...
	public function pgsoftlaunch()
	{
	  ...
	  $body_params_encoded = 'operator_token='.$operator_token.'&path='.urlencode('/'.$game_code.'/').'index.html&extra_args=btt=1&ops='.urlencode($player_token).'&url_type=game-entry&client_ip='.$this->getIP();  
